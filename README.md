...
Evaluated performance using Precision, Recall, F1-score, ROC-AUC, and visualized model performance via confusion matrices and training curves.
Enhanced interpretability by grouping results into Normal, Moderate, and High-risk cardiac categories for clinical insight.

I Also added the data which i used to train the models, which was taken from MIT-BIH Arrhythmia database
